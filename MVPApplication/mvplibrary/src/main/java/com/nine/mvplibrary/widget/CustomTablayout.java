...
import com.nine.mvplibrary.widget.anim.AnimationUtils;
import com.nine.mvplibrary.widget.anim.ValueAnimatorCompat;
import com.nine.mvplibrary.widget.anim.ViewUtils;
 ...
 * </pre>
 * You should set a listener via {@link #setOnTabSelectedListener(CustomTablayout.OnTabSelectedListener)} to be
...
public class CustomTablayout extends HorizontalScrollView {
    ...
    private CustomTablayout.TabLayoutOnPageChangeListener mPageChangeListener;
...
//         TODO add attr for these
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new CustomTablayout.TabLayoutOnPageChangeListener(this);
            }
    ...
    private CustomTablayout.LocationListener locationListener;

    public void setLocationListener(CustomTablayout.LocationListener locationListener) {
...
//                        mIndicatorRight - offset, getHeight(), mSelectedIndicatorPaint);
                ...
                Timber.e(mIndicatorLeft+" "+ (getHeight() - mSelectedIndicatorHeight)+ " "
                        +mIndicatorRight+ " "+getHeight());
                if (locationListener != null) locationListener.location(mIndicatorLeft, getHeight()*2 - mSelectedIndicatorHeight, getHeight());
            }
        }
    }
...
//                tabLayout.getTabAt(position).mView.performClick();
            }
        }
