...
public class PickHistroy {
    ...
    @Generated(hash = 1386548772)
    public PickHistroy(Long ID, @NotNull String VC_Name, @NotNull String VC_Code, String VC_SupplierCode, String vc_billno, String VC_Suppliername, String VC_Specification, String VC_Manufacturer, String VC_Unit, String VC_BatchNumber, String D_Amount, String vc_warehouseCode, String vc_warehousename, String posid, String posno, String D_amount1, String D_money, Integer State, String CartonNo,
            String OperateTime, String temp) {
        this.ID = ID;
